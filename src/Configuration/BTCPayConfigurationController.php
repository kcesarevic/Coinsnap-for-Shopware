...
use Coinsnap\Shopware\PaymentMethod\{LightningPaymentMethod, BitcoinPaymentMethod, LitecoinPaymentMethod, MoneroPaymentMethod, BitcoinLightningPaymentMethod};
